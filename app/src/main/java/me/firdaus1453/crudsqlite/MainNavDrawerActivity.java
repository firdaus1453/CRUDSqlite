...
public class MainNavDrawerActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MainNavDrawerActivity.this,TambahActivity.class));
            }
        });
        ...
        RecycleViewFragment mHome = new RecycleViewFragment();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
                // data akan berubah apabila user menginputkan text
                RecycleViewFragment.doFilter(s);
                return true;
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            mFragment = new RecycleViewFragment();
        } else if (id == R.id.nav_gallery) {
            mFragment = new TambahFragment();
        ...
        // TODO 2 masukkan fragment kedalam activity nya
        if (mFragment != null) {
            getSupportFragmentManager()
                    .beginTransaction()
